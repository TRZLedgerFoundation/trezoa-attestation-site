...
An attestation represents a verified claim or statement in the Trezoa Attestation System. Attestations are created by authorized signers under a credential and follow a specific schema. Each attestation contains the actual data of the claim and metadata about its creation and validity.

## Structure

The Attestation struct represents an attestation in the Trezoa Attestation System. Each attestation links to a credential, schema, and contains the attested data along with metadata about its creation and validity period.
