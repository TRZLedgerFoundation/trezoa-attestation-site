...
This guide builds upon our [Rust TAS Flow Guide](/guides/rust/how-to-create-digital-credentials) where you learned the fundamentals of creating credentials, schemas, and attestations using the Trezoa Attestation Service. In this Part 2, we'll extend your existing trezoa to create **tokenized attestations** - NFTs that represent your digital credentials.
