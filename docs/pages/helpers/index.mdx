...
The Trezoa Attestation Service uses Program Derived Addresses (PDAs) for various purposes. This guide explains the available helper functions for deriving these addresses.
...
- `TAS_SEED`: Used for the TAS authority
...
Derives the address of the TAS authority PDA. This address is used for program signing authority.
