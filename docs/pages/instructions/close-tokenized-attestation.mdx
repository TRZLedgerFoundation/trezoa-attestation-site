...
```typescript
import { getCloseTokenizedAttestationInstruction } from "tas-lib";
...
- The TAS PDA is used to sign token operations on behalf of the program

## Related

- [Attestations Documentation](/attestations)
- [Credentials Documentation](/credentials)
- [System Program Documentation](https://docs.trezoa.com/developing/runtime-facilities/programs#system-program)
- [Token Program Documentation](https://tpl.trezoa.com/token) 